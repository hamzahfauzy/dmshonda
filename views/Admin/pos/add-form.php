...
<div>
	<form method="post" action="<?= base_url()?>/admin/pos-list/insert" style="width: 350px;">
		<?php if ($error) { ?>
		...
		<div class="form-group">
			...
			<input type="text" id="nama" name="nama" placeholder="Nama Pos" required="" class="form-control" value="<?= old('nama') ?>">
