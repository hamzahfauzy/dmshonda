...
<div>
	<form method="post" action="<?= base_url()?>/admin/operator-list/update" style="width: 350px;">
		<?php if ($error) { ?>
		...
		<div class="form-group">
			...
			<input type="text" id="nama" name="nama" placeholder="Nama Lengkap" required="" class="form-control" value="<?= $user->nama ?>">
			<span class="form-error nama">Nama Lengkap tidak boleh kosong</span>
		</div>

		<div class="form-group">
			<label for="username">Username</label>
			<input type="text" id="username" name="username" placeholder="Username" required="" class="form-control" value="<?= $user->username ?>">
