...
<div>
	<form method="post" action="<?= base_url()?>/admin/unit-list/update" style="width: 350px;">
		<?php if ($error) { ?>
		...
		<div class="form-group">
			...
			<select class="form-control" id="jenis" name="jenis_id" required="">
				...
				<option value="<?= $value->id ?>" <?= $unit->jenis_id == $value->id ? 'selected=""' : '' ?>><?= $value->nama ?></option>
				<?php } ?>
			</select>
		...
		<div class="form-group">
			...
			<input type="text" id="no_mesin" name="no_mesin" placeholder="No Mesin" required="" class="form-control" value="<?= $unit->no_mesin ?>">
			<span class="form-error no_mesin">No Mesin tidak boleh kosong</span>
		</div>
		<div class="form-group">
			<label for="warna">Warna</label>
			<input type="text" id="warna" name="warna" placeholder="Warna" required="" class="form-control" value="<?= $unit->warna ?>">
			<span class="form-error warna">Warna tidak boleh kosong</span>
		</div>
		<div class="form-group">
			<label for="nomor_rangka">Nomor Rangka</label>
			<input type="text" id="nomor_rangka" name="nomor_rangka" placeholder="Nomor Rangka" required="" class="form-control" value="<?= $unit->nomor_rangka ?>">
